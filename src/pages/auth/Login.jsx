            ...
            <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl w-full max-w-md z-10 border border-gray-100/50 backdrop-blur-sm">
                  ...
                  ${errors.email
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <Link to="/forgot-password" class="text-xs font-medium text-blue-600 hover:text-blue-700 transition">
                                Forgot Password?
                            </Link>
                        </div>
                        <div className="relative group">
              ...
              ${isLoading ? "bg-blue-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"}`}
                ...
                <p className="mt-8 text-center text-xs text-gray-500">
                    Don't have an account? <span className="text-gray-400 cursor-not-allowed">Contact Admin</span>
                </p>
            </div>
        </div>
    );
