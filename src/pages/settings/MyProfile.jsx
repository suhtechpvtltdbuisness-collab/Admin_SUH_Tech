                ...
                <div className="border-b border-gray-200">
                    <div className="flex">
                        ...
                        <button
                            ...
                            className={`px-6 py-4 font-medium text-sm transition-colors ${activeTab === 'preferences'
                                    ? 'text-blue-600 border-b-2 border-blue-600 bg-blue-50'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-6 py-4 font-medium text-sm transition-colors ${activeTab === 'holidays'
                                    ? 'text-blue-600 border-b-2 border-blue-600 bg-blue-50'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                }`}
                        >
