...
const MOCK_DB = {
  "001": {
    ...
    status: "Active",
    avatar:
      "https://ui-avatars.com/api/?name=Rahul+Sharma&background=0D8ABC&color=fff",
    details: {
      gender: "Male",
      dob: "25 Aug 1995",
      bloodGroup: "B+",
  ...
  "002": {
    ...
    status: "Active",
    avatar:
      "https://ui-avatars.com/api/?name=Priya+Singh&background=D946EF&color=fff",
    details: {
      gender: "Female",
      dob: "12 Dec 1996",
      bloodGroup: "O+",
  ...
  "003": {
    ...
    status: "Active",
    avatar:
      "https://ui-avatars.com/api/?name=Amit+Patel&background=F59E0B&color=fff",
    details: {
      gender: "Male",
      dob: "10 Mar 1990",
      bloodGroup: "A+",
  ...
  "004": {
    ...
    status: "On Leave",
    avatar:
      "https://ui-avatars.com/api/?name=Sneha+Gupta&background=10B981&color=fff",
    details: {
      gender: "Female",
      dob: "20 Aug 1992",
      bloodGroup: "AB+",
  ...
  "005": {
    ...
    status: "Active",
    avatar:
      "https://ui-avatars.com/api/?name=Vikram+Malhotra&background=3B82F6&color=fff",
    details: {
      gender: "Male",
      dob: "15 Jan 1994",
      bloodGroup: "B+",
  ...
  const loadEmployee = async () => {
    try {
      ...
      if (response.employee) {
        ...
        emp.joiningDate =
          emp.joiningDate || emp.dateOfJoining || emp.joinDate || "";
        setEmployee(emp);
      } else {
  ...
  const handleSave = async () => {
    try {
      ...
      if (dataToSave.firstName || dataToSave.lastName) {
        dataToSave.name =
          `${dataToSave.firstName || ""} ${dataToSave.lastName || ""}`.trim();
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 p-6 lg:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <Link
            to="/employees"
            className="inline-flex items-center text-sm text-gray-600 hover:text-blue-600 transition-colors font-semibold"
          >
            ...
            {isEditing ? (
              <>
                <button
                  ...
                  disabled={saving}
                  className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <X size={14} /> Cancel
                </button>
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-semibold shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <button
                onClick={toggleEdit}
                className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 text-sm font-semibold shadow-sm transition-all hover:border-blue-200 hover:text-blue-600"
              >
          ...
          <div className="w-full xl:w-[350px] bg-white border border-gray-200 rounded-2xl p-6 flex-shrink-0 relative">
            ...
            <div className="flex flex-col items-center">
              <div className="relative mb-4">
                <div
                  className="w-28 h-28 rounded-full border-4 border-gray-50 shadow-inner
                                    flex items-center justify-center bg-gray-100 text-center overflow-hidden"
                >
                  {(isEditing ? editedEmployee?.avatar : employee.avatar) ? (
                    <img
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      ...
                      employee.details?.emergencyPhone ||
                      ""
                    }
                    readOnly={!isEditing}
                    onChange={(e) =>
      ...
      <ConfirmationModal
        ...
        confirmText={confirmModal.type === "terminate" ? "Terminate" : "Delete"}
